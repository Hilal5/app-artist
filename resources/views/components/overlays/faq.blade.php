        ...
        <div class="overlay-content">
            ...
            <div class="faq-list" id="faqList">
                ...
                <div class="faq-item" data-category="pricing">
                    ...
                    <div class="faq-answer">
                        <p>Pricing varies depending on complexity, style, and usage rights. Please check my Commission page for detailed pricing tiers. Basic illustration starts from $50, while full character design with multiple views can go up to $300+.</p>
                    </div>
                </div>
                ...
                <div class="faq-item" data-category="process">
                    ...
                    <div class="faq-answer">
                        ...
                        <ul>
                            ...
                            <li>1 round of minor revisions during color phase</li>
                            <li>Additional major revisions can be purchased at $20 per round</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="faq-item" data-category="process">
                    ...
                    <div class="faq-answer">
                        <p>Yes! I provide WIP updates at key stages: sketch, lineart, and coloring. You'll receive updates via email or Discord, and we can discuss changes at each stage.</p>
                    </div>
                </div>
                ...
                <div class="faq-item" data-category="payment">
                    ...
                    <div class="faq-answer">
                        ...
                        <ul>
                            ...
                            <li>Ko-fi</li>
                            <li>Bank transfer (for local clients)</li>
                ...
                <div class="faq-item" data-category="payment">
                    ...
                    <div class="faq-answer">
                        ...
                        <ul>
                            <li>50% upfront deposit to start the commission</li>
                            <li>50% final payment before delivery of final files</li>
                            <li>For orders over $500, we can arrange a payment plan</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="faq-cta">
                ...
                <p>Feel free to reach out via email or Discord!</p>
